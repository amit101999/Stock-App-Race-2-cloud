...
const runMigration = (rc, migFiles, idx = 0) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (0, index_1.debug)('migration failed for v' + currentMigFileVersion);
...
const runGlobalMigration = (migFiles) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (0, index_1.debug)('migration failed for v' + currentMigFileVersion);
        config_store_js_1.default.set('migration.' + currentMigFileVersion.replace(new RegExp('\\.', 'g'), '\\.'), {
            error: (0, util_1.inspect)(e),
            completed: false
        });
        const err = index_js_1.default.getErrorInstance(e, {
    ...
    config_store_js_1.default.set('migration.last_success', currentMigFileVersion);
    (0, index_1.debug)('migration completed for v' + currentMigFileVersion);
    return runGlobalMigration(migFiles);
});
