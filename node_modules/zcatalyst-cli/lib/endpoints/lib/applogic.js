...
class Applogic {
    ...
    deploy(sourceFsStream, { stack, name, memory, envVariables, contentLength }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('save applogic response from server : ' + res.body);
    ...
    getAllApplogic() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('get applogic response from server : ' + res.body);
            throw new index_js_1.default('Server Error: Unexpected Response from server.', {
                exit: 2
            });
        });
    ...
    download(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('java sdk response from server : ' + res.body);
            throw new index_js_1.default('Server Error: Unexpected Response from server.', {
                exit: 2
            });
        });
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('delete applogic response from server : ' + res.body);
            throw new index_js_1.default('Server Error: Unexpected Response from server.', {
                exit: 2
            });
        });
