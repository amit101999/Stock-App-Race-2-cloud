    ...
    getLatestZipUrl(repo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (er instanceof error_1.default && 'body' in er.context) {
                    const body = er.context.body;
                    throw new error_1.default('Error communicating with GitHub', {
                        exit: 1,
                        errorId: 'GIT-HUB-1',
                        arg: [ansi_colors_1.italic.red(body.message), (0, ansi_colors_1.underline)(body.documentation_url)]
                    });
                }
                throw er;
            }
