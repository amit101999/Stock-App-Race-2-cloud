...
class Apig {
    ...
    getRules(from, apiCount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('get all apis response from server : ' + res.body);
    ...
    deploy(sourceStream) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('deploy APIG response from server : ' + res.body);
            throw new index_js_1.default('Server Error: Unexpected Response from server.', {
                exit: 2
            });
        });
    ...
    getScheduleReport(prev = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('getScheduleReport response from server : ' + res.body);
            throw new index_js_1.default('Server Error: Unexpected Response from server.', {
                exit: 2
            });
        });
    ...
    updateAPIGStatus(status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('change status of APIG response from server : ' + res.body);
            throw new index_js_1.default('Server Error: Unexpected Response from server.', {
                exit: 2
            });
        });
