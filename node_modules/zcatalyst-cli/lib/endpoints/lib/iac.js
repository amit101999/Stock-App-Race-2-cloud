...
class IacAPI {
    ...
    deploy(projectName, format, file, schedule = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('deploy response from server : ' + JSON.stringify(res.body));
            throw new index_js_1.default('Server Error: Unexpected Response from server.', { exit: 2 });
        });
    }
    update(file) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    bundle(format) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('bundle response from server : ' + JSON.stringify(res.body));
            throw new index_js_1.default('Server Error: Unexpected Response from server.', { exit: 2 });
        });
    }
    bundleStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('bundle status response from server : ' + JSON.stringify(res.body));
            throw new index_js_1.default('Server Error: Unexpected Response from server.', { exit: 2 });
        });
    }
    bundleDownload() {
    ...
    allDeploys() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, index_1.debug)('export response from server : ' + JSON.stringify(res.body));
            throw new index_js_1.default('Server Error: Unexpected Response from server.', { exit: 2 });
        });
    }
