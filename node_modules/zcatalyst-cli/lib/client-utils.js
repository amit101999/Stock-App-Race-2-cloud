...
exports.clientUtils = {
    validate: ({ source, skipPluginValidation = false } = {}) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const sourceDir = source || config_1.clientConfig.source();
        ...
        if (!sourceDirExists) {
            throw new index_js_1.default('source directory does not exist', {
                exit: 1,
        ...
        const packageJson = yield fs_1.ASYNC.readJSONFile(packageJsonFile, {
            ...
            throw new index_js_1.default(constants_1.FILENAME.client.package_json + ' file cannot be parsed.', {
                exit: 1,
                original: e,
        ...
        if (packageJson === undefined) {
            throw new index_js_1.default(constants_1.FILENAME.client.package_json + ' file was not found.', {
                exit: 1,
        ...
        if (homepage === notFoundPagePath) {
            throw new index_js_1.default('404 page and homepage cannot be the same', {
                exit: 1,
        ...
        if (js_1.JS.isNull(name)) {
            throw new index_js_1.default(constants_1.FILENAME.client.package_json + ' file is corrupted.', {
                exit: 1,
        ...
        if (!skipPluginValidation) {
            const validatePlugin = yield (0, plugin_loader_1.default)('client', 'validate').catch((err) => (0, index_1.debug)(err));
            if (typeof validatePlugin !== 'function') {
                runtime_store_1.default.set('context.client.valid', true);
                return packageJson;
            }
            const logStreamPlugin = yield (0, plugin_loader_1.default)('client', 'logs').catch((err) => (0, index_1.debug)(err));
            let stream;
            const streamLogFn = (chunk) => (0, index_1.log)('info', chunk.toString(), true);
    ...
    executeHook: ({ prefix, command }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return (0, execute_script_1.default)('client:' + prefix + command);
    }),
    pack: () => __awaiter(void 0, void 0, void 0, function* () {
        let source = config_1.clientConfig.source();
        const buildPlugin = yield (0, plugin_loader_1.default)('client', 'build').catch((err) => (0, index_1.debug)(err));
        if (typeof buildPlugin === 'function') {
            ...
            try {
                (0, index_1.message)(`Plugin : "${runtime_store_1.default.get(`context.client.plugins.build`)}" is used for client deploy`);
                (0, index_1.message)('Building Application...');
