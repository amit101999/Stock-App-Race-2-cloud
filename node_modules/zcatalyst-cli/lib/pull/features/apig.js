...
exports.default = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((0, sync_1.isPathOutside)(runtime_store_1.default.get('project.root'), apigDirPath)) {
        (0, index_1.info)('Skipping APIG pull since rules file is outside root dir : ' +
    ...
    fileExists && (yield fs_1.ASYNC.deleteFile(apigDirPath).catch());
    const rulesArr = (yield apigAPIs.getAllRules());
    if (!rulesArr || rulesArr.length === 0) {
        (0, index_1.info)('No rules found in remote console');
        return;
    }
    try {
        ...
        runtime_store_1.default.set('context.payload.apig.status', 1);
    ...
    runtime_store_1.default.set('context.payload.apig.source', apigDirPath);
});
