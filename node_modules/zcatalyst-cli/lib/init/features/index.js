...
function setCatalystConfig(featureName, add) {
    const featureContext = runtime_store_1.default.get('context.payload.' + featureName, null);
    let featureContextArr = runtime_store_1.default.get('context.payload.' + featureName + '.targets', null);
    ...
    if (featureContextArr === null) {
        throw new index_js_1.default('No context given to populate catalyst.json', {
            exit: 2
        });
    }
...
function project() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const projectPayload = runtime_store_1.default.get('context.payload.project', null);
        if (!projectPayload) {
            return;
        }
        ...
        yield upsertEnvArr(runtime_store_1.default.get('context.payload.env', null));
        if (runtime_store_1.default.get('context.payload.project.new', false)) {
            (0, index_1.message)('New Project has been successfully created and associated with this directory.');
        }
        (0, index_1.message)((0, ansi_colors_1.bold)(constants_1.FILENAME.rc) + ' file has be successfully created with project details.');
        const isImport = runtime_store_1.default.get('context.payload.project.import', false);
        if (isImport) {
