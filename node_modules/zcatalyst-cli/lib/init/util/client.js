...
function directoryOverridePrompt(dir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (foldeExists) {
            const overwriteAns = yield index_js_2.default.ask(index_js_2.default.question('overwrite', 'Directory ' + (0, ansi_colors_1.underline)(dir) + ' already exists. Overwrite ?', {
                type: 'confirm',
                defaultAns: false
            }));
            if (!overwriteAns.overwrite) {
                throw new index_js_1.default('Skipping client setup since unable to override the already existing client', { exit: 0, errorId: 'CLIENT-UTILS-6', arg: [ansi_colors_1.italic.red(dir)] });
            }
...
function addDependency(filePath, dep, { dev = false, depPath = [] } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const err = index_js_1.default.getErrorInstance(e, { skipHelp: true });
            (0, index_1.debug)(`unable to write to ${filePath}: ${err.message}`);
        }
    });
}
