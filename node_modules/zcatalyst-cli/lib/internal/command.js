...
class Command {
    ...
    register(client, cli) {
        ...
        cmd.action((...programArgs) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.isCICommand && env_1.isCI) {
                return (0, errorOut_1.default)(new index_js_1.default('Environment not supported', {
                    exit: 1,
                    errorId: 'CMD-2',
    ...
    _prepare(cmd) {
        ...
        if (!runtime_store_1.default.get('project.root', false)) {
            runtime_store_1.default.set('project.root', (0, project_1.getProjectRoot)());
        }
        if (!runtime_store_1.default.get('cwd', false)) {
    ...
    runner() {
        return (...args) => __awaiter(this, void 0, void 0, function* () {
            ...
            const unknownOpts = this.allowUnknownOptions
                ...
                : undefined;
            runtime_store_1.default.set('context.opts', Object.assign({ _name: command.name(), unknownOpts }, opts));
            this._prepare(this.isSubCommand && command.parent ? command.parent : command);
            try {
                yield (0, migration_1.default)(runtime_store_1.default.get('cli.package.version'));
            }
            catch (e) {
                (0, index_1.debug)(e);
            }
