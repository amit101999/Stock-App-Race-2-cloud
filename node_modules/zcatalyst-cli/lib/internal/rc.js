...
class RC {
    ...
    removeEnv(projectId, envId) {
        ...
        if (removedEnvArr.length !== 0) {
            throw new index_js_1.default('Unable to find and remove environment object in RC file with env ID : ' + envId, { exit: 2 });
        }
    ...
    removeProject(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (removedProjectArr.length !== 1) {
                throw new index_js_1.default('Unable to find and remove project object in RC file with project ID : ' + id, { exit: 2 });
            }
            if (projectArr.length === 0) {
                (0, index_1.warning)('No projects found in ' + constants_1.FILENAME.rc + ' hence removing it.');
                return this.delete();
            }
