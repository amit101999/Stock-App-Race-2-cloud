...
function raw(throwError = false) {
    ...
    if (config === null) {
        if (throwError) {
            throw new index_js_1.default(file_names_js_1.default.config + ' file is required', { exit: 2 });
        }
        return;
    }
...
function source(fallback = folder_names_js_1.default.client) {
    ...
    if (!resolvedSource.startsWith((0, project_js_1.getProjectRoot)())) {
        throw new index_js_1.default('Invalid source path for functions. Source path outside project root', {
            exit: 1,
            context: {
