...
function spawn(command, opts, _a = {}) {
    ...
    Object.keys(otherOpts.env)
        .filter((key) => {
        if (key.startsWith('ELECTRON') || key.startsWith('VSCODE')) {
            return true;
        }
        return false;
    })
        .forEach((key) => {
        otherOpts.env && delete otherOpts.env[key];
    });
    return {
        ...
        ASYNC: () => {
            ...
            return new Promise((res, rej) => {
                ...
                let stdout = '';
                let stderr = '';
                (_a = childProcess.stderr) === null || _a === void 0 ? void 0 : _a.on('data', (msg) => {
                    stderr += msg.toString();
                });
                (_b = childProcess.stdout) === null || _b === void 0 ? void 0 : _b.on('data', (msg) => {
                    stdout += msg.toString();
                });
                ...
                childProcess.on('exit', (code) => {
                    ...
                    res({ message, stdout, stderr, status: code || 0 });
                });
            });
        },
        RAW: () => {
