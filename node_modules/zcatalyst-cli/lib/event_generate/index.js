...
function generate(source, action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let eventBusName = (0, option_1.getOptionValue)('eventBus', undefined);
        if (!eventBusName) {
                ...
                case 'action':
                    ...
                    if (indexOfAction < 0) {
                        ...
                        throw new error_1.default('Action incompatible with the source ' + eventRefArr, {
                            exit: 1,
                            errorId: 'IDX-6',
                            arg: [(0, ansi_colors_1.bold)(action), ansi_colors_1.bold.red('X'), (0, ansi_colors_1.bold)(source), (0, ansi_colors_1.bold)(availableActions)]
                        });
                    }
