...
exports.default = (inputs) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (input.length === 1 && input[0] !== '') {
        throw new index_js_1.default('incorrect input for event cliq', {
            exit: 1,
            errorId: 'CLIQ-1',
        ...
        if (handlers_event_template[inputComponent] !== undefined &&
            ...
            throw new index_js_1.default('invalid input combination', {
                exit: 1,
                errorId: 'CLIQ-2',
    ...
    if (!fs_1.ASYNC.fileExists(filePath)) {
        throw new index_js_1.default("Couldn't read request template", { exit: 2 });
    }
