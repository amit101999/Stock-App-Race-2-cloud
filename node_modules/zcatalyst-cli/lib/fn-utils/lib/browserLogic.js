...
function getBrowserLogicFramework(stack) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const framework = yield prompt_1.default.ask(prompt_1.default.question('framework', 'Please choose a framework to initialize', {
            type: 'list',
            choices
        }));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Promise.all(deps.map((dep) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, index_1.labeled)(`Browser Logic[${name}]`, 'Unable to download the dependencies because of the following error');
                (0, index_1.error)((0, util_1.inspect)(err));
            }
        })));
    });
}
