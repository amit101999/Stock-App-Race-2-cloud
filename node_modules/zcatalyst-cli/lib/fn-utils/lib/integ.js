...
function integHelper(services) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (serviceChoices.length === 0) {
            throw new index_js_1.default(`Invalid integration services: [${services.join(',')}]`, {
                exit: 2
            });
        }
...
function copyIntegHandlers(templatePath, targetPath, lang) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!service) {
            throw new index_js_1.default('Unable to get service from runtime', { exit: 2 });
        }
        ...
        switch (service) {
            case constants_1.INTEG.services.cliq:
                ...
                if (lang === runtime_1.default.language.node.value) {
                    ...
                    const handlerString = JSON.stringify({ handlers: integHandlerConfig }, null, '\t').replace(new RegExp('\n', 'g'), '\n\t');
                    runtime_store_1.default.set('context.functions.integration.handlers', handlerString);
                }
                break;
