...
function prepareFunctions(targets) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        targets.forEach((tar) => {
            ...
            if ((_a = tar.stack) === null || _a === void 0 ? void 0 : _a.startsWith(runtime_1.default.language.node.value)) {
                return nodeFns.push(tar);
            }
            if ((_b = tar.stack) === null || _b === void 0 ? void 0 : _b.startsWith(runtime_1.default.language.java.value)) {
                return javaFns.push(tar);
            }
            if ((_c = tar.stack) === null || _c === void 0 ? void 0 : _c.startsWith(runtime_1.default.language.python.value)) {
                return pythonFns.push(tar);
            }
            return;
        });
