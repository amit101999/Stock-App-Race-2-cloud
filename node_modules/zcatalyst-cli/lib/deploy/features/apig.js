...
exports.default = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (response.scheduled) {
        (0, index_1.labeled)('apig', 'Skipping deploy since previous schedule is not over yet.').ERROR();
        (0, index_1.labeled)('apig', 'You can deploy apig separately using "--only apig" option next time.').MESSAGE();
        return;
    }
    if (config_1.apigConfig.enabled(null) === null) {
        throw new index_js_1.default('Skipping deploy, since unable to detect the status of API Gateway from ' +
    ...
    if (!config_1.apigConfig.enabled()) {
        if (response.status) {
            ...
            (0, index_1.labeled)('apig', 'Disabled successfully').SUCCESS();
        }
        throw new index_js_1.default('APIG not enabled locally', {
            errorId: 'APIG-1',
