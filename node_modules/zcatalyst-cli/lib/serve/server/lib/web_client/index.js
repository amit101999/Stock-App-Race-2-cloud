...
exports.default = (details, masterPort) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const servePlugin = yield (0, plugin_loader_1.default)('client', 'start', target.source).catch((err) => (0, index_1.debug)(err));
    if (typeof servePlugin === 'function') {
        process.env.X_CATALYST_WEBAPP_PATH = target.source;
        const logStreamPlugin = yield (0, plugin_loader_1.default)('client', 'logs', target.source).catch((err) => (0, index_1.debug)(err));
        ...
        (0, index_1.info)();
        (0, index_1.labeled)(`Client[${target.name}]`, `Plugin : "${runtime_store_1.default.get(`context.client.plugins.start${target.source ? '.' + target.source : ''}`)}" is used for ${details.type} serve`).MESSAGE();
        (0, index_1.info)();
        return event;
    }
