    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (reloadScriptSrc) {
            ...
            clientWatcher.on('error', (err) => {
                watcherReady = false;
                eventListener.emit('error', new error_1.default('slate watcher error', {
                    original: err,
                    exit: 1,
                    skipHelp: true
                }));
            ...
            clientWatcher.on('ready', () => {
                ...
                const socketServer = new ws_1.WebSocketServer({
                    ...
                    .on('error', (err) => (0, logger_1.debug)(err));
                setTimeout(() => {
            ...
            eventListener.addListener('close', () => {
                ...
                index_js_1.SYNC.deleteDir(reloadScriptSrc);
            });
        }
        ...
        app.use('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (enableWatch && (requestedFile.includes('.html') || requestedFile.includes('.htm'))) {
                const htmlFile = yield index_js_1.ASYNC.readFile((0, path_1.join)(source, requestedFile));
                if (!htmlFile) {
                    res.contentType('text/html');
                    res.status(404);
                    res.end();
                    eventListener.emit('error', new error_1.default('Unable to read the html file', {
                        exit: 1,
                        errorId: 'SL-SERVER-1',
            ...
            res.sendFile((0, path_1.join)(source, requestedFile), (err) => {
                ...
                if (err.code &&
                    err.code === 'ENOENT') {
                    (0, logger_1.error)((0, ansi_colors_1.red)('[404 - Resource not found]: ') + (0, ansi_colors_1.bold)(requestedFile));
                    (0, logger_1.info)();
                    (0, logger_1.debug)(err.stack || err.message);
                    res.status(404);
                    notFoundPage
                        ? res.sendFile(notFoundPage, (e) => {
                            ...
                            (0, logger_1.debug)('Unable to send the 404 page to server: ', e);
                            res.status(500);
                ...
                (0, logger_1.error)('Error fetching the resource: ' + err);
        ...
        eventListener.on('close', () => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, logger_1.debug)('client server closed');
        }));
