...
exports.appsailInitJs = exports.proxyResponseHandler = exports.createProxyServer = exports.redirectByAuth = exports.removeSecure = exports.serverEvent = void 0;
...
const createProxyServer = (port) => {
    const proxy = (0, http_proxy_1.createProxyServer)({
        ...
        (0, index_1.debug)('Connection reset from target URL : ', targetUrl);
        console.error(err);
    })
        .on('close', () => (0, index_1.debug)('proxy closed'));
    return proxy;
};
