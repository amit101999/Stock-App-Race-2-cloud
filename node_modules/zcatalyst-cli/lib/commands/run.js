...
exports.default = new command_1.default('run-script [command]')
    ...
    Object.keys(config).forEach((key) => {
        ...
        if (lifeCycleScripts.length !== 0) {
            (0, index_1.info)(`Lifecycle scripts for ${(0, ansi_colors_1.cyan)(key)} :`);
            (0, index_1.info)(lifeCycleScripts.join(','));
            (0, index_1.info)();
        }
        if (otherScripts.length !== 0) {
            (0, index_1.info)(`Other scripts for ${(0, ansi_colors_1.cyan)(key)} :`);
            (0, index_1.info)(otherScripts.join('\n'));
            (0, index_1.info)();
        }
    });
    (0, index_1.info)('To run a specific script, execute ' + (0, ansi_colors_1.bold)('catalyst run [feature:script]'));
    (0, index_1.info)('For example ' + (0, ansi_colors_1.bold)('catalyst run functions:predeploy'));
    return;
}));
