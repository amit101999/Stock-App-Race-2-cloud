...
exports.default = new command_1.default('functions:shell')
    ...
    if (enableTunnelOpt) {
        ...
        if (tunnelDetails.tunnel_status === 'Disabled') {
            ...
            (0, index_1.info)();
            (0, index_1.info)(`Tunneling is already enabled for the project ${(0, ansi_colors_1.bold)((0, project_1.getProjectName)())}(${(0, project_1.getProjectId)()}) with the configurations below:`);
            (0, index_1.info)();
            (0, index_1.info)((0, ansi_colors_1.bold)('Tunneling URL: ') + ansi_colors_1.italic.underline(tunnelDetails.tunnel_url));
            (0, index_1.info)((0, ansi_colors_1.bold)('Tunneled functions: '));
            tunnelDetails.function_details.forEach((fn) => {
                (0, index_1.info)('* ' + fn.name);
            });
            (0, index_1.info)((0, ansi_colors_1.bold)('Enabled by: ') + (0, ansi_colors_1.italic)(tunnelDetails.created_by.email_id));
            (0, index_1.info)((0, ansi_colors_1.bold)('Enabled on: ') + tunnelDetails.enabled_time);
            (0, index_1.info)();
            if (typeof enableTunnelOpt === 'boolean') {
                ...
                (0, index_1.info)();
                (0, index_1.info)('Ignoring `--enable-tunnel` option since tunneling is already enabled');
                (0, index_1.info)();
            }
