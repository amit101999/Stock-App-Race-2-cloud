...
// import CatalystError from '../error/index';
...
class Throbber {
    ...
    static getInstance(options = {}) {
        ...
        const instance = new Throbber(Object.assign({ spinnerColor: 'cyanBright', spinner: (0, utils_1.supportsUnicode)() ? spinners_json_1.dots : spinners_json_1.dashes, disableSpins: false, status: 'spinning', succeedPrefix: utils_1.CHAR.success, failPrefix: utils_1.CHAR.error }, options));
    ...
    loopStream() {
        if (this.options.spinner === undefined) {
            throw new Error('LoopStream must be called only with valid spinner object');
        }
